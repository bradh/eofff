...
public class CreateAvifMini12Test extends GIMIValidator {

    private static final Logger LOG = LoggerFactory.getLogger(CreateAvifMini12Test.class);
    private MediaDataBox mdat;
    private AV1CodecConfigurationBox av1C;
    private final List<Box> sourceBoxes;

    public CreateAvifMini12Test() throws IOException, InterruptedException, URISyntaxException {
        {
            FileParser fileParser = new FileParser();
            sourceBoxes =
                    fileParser.parse(
                            Path.of(
                                    CreateAvifMini12Test.class
                                            .getResource("/lightning128x128_12bpp_colr.avif")
                                            .toURI()));
    ...
    public void writeAVIF() throws IOException {
        ...
        boxes.add(mini);
        writeBoxes(boxes, "lightning_mini_12.avif");
    }
