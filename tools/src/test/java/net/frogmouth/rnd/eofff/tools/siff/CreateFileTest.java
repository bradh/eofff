...
public class CreateFileTest {
    ...
    private Box makeItemPropertiesBox() {
        ...
        componentDefinitionAssociationEntry.setItemId(0);
        PropertyAssociation propAssociation = new PropertyAssociation();
        propAssociation.setPropertyIndex(0);
        propAssociation.setEssential(true);
        componentDefinitionAssociationEntry.addAssociation(propAssociation);
