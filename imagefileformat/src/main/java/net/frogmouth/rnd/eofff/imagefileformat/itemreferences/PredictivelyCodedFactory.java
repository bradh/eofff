...
public class PredictivelyCodedFactory implements ItemReferenceFactory {

    @Override
    public FourCC getFourCC() {
        return PredictivelyCoded.PRED_ATOM;
    }

    @Override
    public SingleItemReferenceBox makeItemReference(FourCC referenceType) {
        return new PredictivelyCoded();
    }
}
