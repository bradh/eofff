...
public class ConformanceMIAF005Test {
    private static final Logger LOG = LoggerFactory.getLogger(ConformanceMIAF005Test.class);
    private List<Box> boxes;

    private Path getExample() {
        String fileName = "heif_conformance/conformance_files/MIAF005.heic";
    ...
    public void checkFtypBox() {
        ...
        assertEquals(ftyp.getCompatibleBrands().get(5), new Brand("MiAn"));
