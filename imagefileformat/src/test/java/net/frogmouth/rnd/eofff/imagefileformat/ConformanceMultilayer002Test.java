...
public class ConformanceMultilayer002Test {
    private static final Logger LOG = LoggerFactory.getLogger(ConformanceMultilayer002Test.class);
    private List<Box> boxes;

    private Path getExample() {
        String fileName = "heif_conformance/conformance_files/multilayer002.heic";
