...
public class ConformanceC047Test {
    private static final Logger LOG = LoggerFactory.getLogger(ConformanceC047Test.class);
    private List<Box> boxes;

    public ConformanceC047Test() {}

    private Path getExample() {
        String fileName = "heif_conformance/conformance_files/C047.heic";
