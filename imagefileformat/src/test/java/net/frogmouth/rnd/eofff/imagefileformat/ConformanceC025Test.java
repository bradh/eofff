...
public class ConformanceC025Test {
    private static final Logger LOG = LoggerFactory.getLogger(ConformanceC025Test.class);
    private List<Box> boxes;

    public ConformanceC025Test() {}

    private Path getExample() {
        String fileName = "heif_conformance/conformance_files/C025.heic";
