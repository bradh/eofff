...
public class ConformanceC016Test {
    private static final Logger LOG = LoggerFactory.getLogger(ConformanceC016Test.class);
    private List<Box> boxes;

    public ConformanceC016Test() {}

    private Path getExample() {
        String fileName = "heif_conformance/conformance_files/C016.heic";
