...
public class ConformanceC036Test {
    private static final Logger LOG = LoggerFactory.getLogger(ConformanceC036Test.class);
    private List<Box> boxes;

    public ConformanceC036Test() {}

    private Path getExample() {
        String fileName = "heif_conformance/conformance_files/C036.heic";
