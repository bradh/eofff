...
public class ConformanceC019Test {
    private static final Logger LOG = LoggerFactory.getLogger(ConformanceC019Test.class);
    private List<Box> boxes;

    public ConformanceC019Test() {}

    private Path getExample() {
        String fileName = "heif_conformance/conformance_files/C019.heic";
