...
public class ConformanceC003Test {
    private static final Logger LOG = LoggerFactory.getLogger(ConformanceC003Test.class);
    private List<Box> boxes;

    public ConformanceC003Test() {}

    private Path getExample() {
        String fileName = "heif_conformance/conformance_files/C003.heic";
