...
public class ConformanceC051Test {
    private static final Logger LOG = LoggerFactory.getLogger(ConformanceC051Test.class);
    private List<Box> boxes;

    private Path getExample() {
        String fileName = "heif_conformance/conformance_files/C051.heic";
