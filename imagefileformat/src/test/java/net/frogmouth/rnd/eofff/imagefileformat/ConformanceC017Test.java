...
public class ConformanceC017Test {
    private static final Logger LOG = LoggerFactory.getLogger(ConformanceC017Test.class);
    private List<Box> boxes;

    public ConformanceC017Test() {}

    private Path getExample() {
        String fileName = "heif_conformance/conformance_files/C017.heic";
