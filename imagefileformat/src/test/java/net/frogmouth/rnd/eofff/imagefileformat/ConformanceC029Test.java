...
public class ConformanceC029Test {
    private static final Logger LOG = LoggerFactory.getLogger(ConformanceC029Test.class);
    private List<Box> boxes;

    public ConformanceC029Test() {}

    private Path getExample() {
        String fileName = "heif_conformance/conformance_files/C029.heic";
