...
public class ConformanceC052Test {
    private static final Logger LOG = LoggerFactory.getLogger(ConformanceC052Test.class);
    private List<Box> boxes;

    private Path getExample() {
        String fileName = "heif_conformance/conformance_files/C052.heic";
