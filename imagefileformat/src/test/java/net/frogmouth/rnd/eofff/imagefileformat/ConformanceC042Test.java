...
public class ConformanceC042Test {
    private static final Logger LOG = LoggerFactory.getLogger(ConformanceC042Test.class);
    private List<Box> boxes;

    public ConformanceC042Test() {}

    private Path getExample() {
        String fileName = "heif_conformance/conformance_files/C042.heic";
