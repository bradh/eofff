...
public class ConformanceC012Test {
    private static final Logger LOG = LoggerFactory.getLogger(ConformanceC012Test.class);
    private List<Box> boxes;

    public ConformanceC012Test() {}

    private Path getExample() {
        String fileName = "heif_conformance/conformance_files/C012.heic";
