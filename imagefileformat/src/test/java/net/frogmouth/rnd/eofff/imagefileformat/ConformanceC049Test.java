...
public class ConformanceC049Test {
    private static final Logger LOG = LoggerFactory.getLogger(ConformanceC049Test.class);
    private List<Box> boxes;

    private Path getExample() {
        String fileName = "heif_conformance/conformance_files/C049.heic";
