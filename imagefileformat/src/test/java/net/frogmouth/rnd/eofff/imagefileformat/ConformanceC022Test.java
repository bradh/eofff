...
public class ConformanceC022Test {
    private static final Logger LOG = LoggerFactory.getLogger(ConformanceC022Test.class);
    private List<Box> boxes;

    public ConformanceC022Test() {}

    private Path getExample() {
        String fileName = "heif_conformance/conformance_files/C022.heic";
