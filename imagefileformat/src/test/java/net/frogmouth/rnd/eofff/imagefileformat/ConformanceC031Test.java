...
public class ConformanceC031Test {
    private static final Logger LOG = LoggerFactory.getLogger(ConformanceC031Test.class);
    private List<Box> boxes;

    public ConformanceC031Test() {}

    private Path getExample() {
        String fileName = "heif_conformance/conformance_files/C031.heic";
