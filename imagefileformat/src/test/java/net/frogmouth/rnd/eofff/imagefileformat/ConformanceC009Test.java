...
public class ConformanceC009Test {
    private static final Logger LOG = LoggerFactory.getLogger(ConformanceC009Test.class);
    private List<Box> boxes;

    public ConformanceC009Test() {}

    private Path getExample() {
        String fileName = "heif_conformance/conformance_files/C009.heic";
