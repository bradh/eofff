...
public class ConformanceMIAF002Test {
    private static final Logger LOG = LoggerFactory.getLogger(ConformanceMIAF002Test.class);
    private List<Box> boxes;

    private Path getExample() {
        String fileName = "heif_conformance/conformance_files/MIAF002.heic";
    ...
    public void checkFtypBox() {
        ...
        assertEquals(ftyp.getCompatibleBrands().get(3), new Brand("MiHA"));
    }
}
