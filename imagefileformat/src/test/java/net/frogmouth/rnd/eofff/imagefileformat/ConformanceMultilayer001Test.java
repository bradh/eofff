...
public class ConformanceMultilayer001Test {
    private static final Logger LOG = LoggerFactory.getLogger(ConformanceMultilayer001Test.class);
    private List<Box> boxes;

    private Path getExample() {
        String fileName = "heif_conformance/conformance_files/multilayer001.heic";
