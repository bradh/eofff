...
public class ConformanceC002Test {
    private static final Logger LOG = LoggerFactory.getLogger(ConformanceC002Test.class);
    private List<Box> boxes;

    public ConformanceC002Test() {}

    private Path getExample() {
        String fileName = "heif_conformance/conformance_files/C002.heic";
