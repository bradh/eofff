...
public class ConformanceC050Test {
    private static final Logger LOG = LoggerFactory.getLogger(ConformanceC050Test.class);
    private List<Box> boxes;

    private Path getExample() {
        String fileName = "heif_conformance/conformance_files/C050.heic";
