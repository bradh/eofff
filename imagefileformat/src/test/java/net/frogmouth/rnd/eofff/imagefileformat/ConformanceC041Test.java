...
public class ConformanceC041Test {
    private static final Logger LOG = LoggerFactory.getLogger(ConformanceC041Test.class);
    private List<Box> boxes;

    public ConformanceC041Test() {}

    private Path getExample() {
        String fileName = "heif_conformance/conformance_files/C041.heic";
