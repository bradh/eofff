...
public class ConformanceC004Test {
    private static final Logger LOG = LoggerFactory.getLogger(ConformanceC004Test.class);
    private List<Box> boxes;

    public ConformanceC004Test() {}

    private Path getExample() {
        String fileName = "heif_conformance/conformance_files/C004.heic";
