...
public class ConformanceC010Test {
    private static final Logger LOG = LoggerFactory.getLogger(ConformanceC010Test.class);
    private List<Box> boxes;

    public ConformanceC010Test() {}

    private Path getExample() {
        String fileName = "heif_conformance/conformance_files/C010.heic";
