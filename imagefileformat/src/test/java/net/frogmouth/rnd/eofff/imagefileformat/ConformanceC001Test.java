...
public class ConformanceC001Test {
    ...
    private Path getExample() {
        String fileName = "heif_conformance/conformance_files/C001.heic";
    ...
    public void checkFtypBox() {
        ...
        assertEquals(ftyp.getCompatibleBrands().get(3), new FourCC("mif1"));
        assertEquals(ftyp.getCompatibleBrands().get(4), new FourCC("iso8"));
    }
