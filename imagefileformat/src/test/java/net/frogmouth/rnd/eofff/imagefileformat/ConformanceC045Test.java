...
public class ConformanceC045Test {

    private static final Logger LOG = LoggerFactory.getLogger(ConformanceC045Test.class);
    private List<Box> boxes;

    public ConformanceC045Test() {}

    private Path getExample() {
        String fileName = "heif_conformance/conformance_files/C045.heic";
