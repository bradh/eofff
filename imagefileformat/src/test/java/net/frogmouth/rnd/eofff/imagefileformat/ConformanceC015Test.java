...
public class ConformanceC015Test {
    private static final Logger LOG = LoggerFactory.getLogger(ConformanceC015Test.class);
    private List<Box> boxes;

    public ConformanceC015Test() {}

    private Path getExample() {
        String fileName = "heif_conformance/conformance_files/C015.heic";
