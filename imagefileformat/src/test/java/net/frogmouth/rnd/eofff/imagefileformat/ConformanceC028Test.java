...
public class ConformanceC028Test {
    private static final Logger LOG = LoggerFactory.getLogger(ConformanceC028Test.class);
    private List<Box> boxes;

    public ConformanceC028Test() {}

    private Path getExample() {
        String fileName = "heif_conformance/conformance_files/C028.heic";
