...
public class ConformanceC011Test {
    private static final Logger LOG = LoggerFactory.getLogger(ConformanceC011Test.class);
    private List<Box> boxes;

    public ConformanceC011Test() {}

    private Path getExample() {
        String fileName = "heif_conformance/conformance_files/C011.heic";
