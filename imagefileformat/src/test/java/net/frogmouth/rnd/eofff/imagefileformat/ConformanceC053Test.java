...
public class ConformanceC053Test {
    private static final Logger LOG = LoggerFactory.getLogger(ConformanceC053Test.class);
    private List<Box> boxes;

    private Path getExample() {
        String fileName = "heif_conformance/conformance_files/C053.heic";
