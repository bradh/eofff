...
public class ConformanceC040Test {
    private static final Logger LOG = LoggerFactory.getLogger(ConformanceC040Test.class);
    private List<Box> boxes;

    public ConformanceC040Test() {}

    private Path getExample() {
        String fileName = "heif_conformance/conformance_files/C040.heic";
