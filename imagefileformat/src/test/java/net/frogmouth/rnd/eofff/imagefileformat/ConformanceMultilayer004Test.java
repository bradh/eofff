...
public class ConformanceMultilayer004Test {
    private static final Logger LOG = LoggerFactory.getLogger(ConformanceMultilayer004Test.class);
    private List<Box> boxes;

    private Path getExample() {
        String fileName = "heif_conformance/conformance_files/multilayer004.heic";
    ...
    public void checkFtypBox() {
        ...
        assertEquals(ftyp.getCompatibleBrands().get(1), ImageFileFormatBrand.HEIS);
        assertEquals(ftyp.getCompatibleBrands().get(2), ImageFileFormatBrand.AVCI);
    }
}
