...
public class ConformanceC020Test {
    private static final Logger LOG = LoggerFactory.getLogger(ConformanceC020Test.class);
    private List<Box> boxes;

    public ConformanceC020Test() {}

    private Path getExample() {
        String fileName = "heif_conformance/conformance_files/C020.heic";
