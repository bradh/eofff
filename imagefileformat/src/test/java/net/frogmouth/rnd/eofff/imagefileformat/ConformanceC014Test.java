...
public class ConformanceC014Test {
    private static final Logger LOG = LoggerFactory.getLogger(ConformanceC014Test.class);
    private List<Box> boxes;

    public ConformanceC014Test() {}

    private Path getExample() {
        String fileName = "heif_conformance/conformance_files/C014.heic";
