...
public class ConformanceC043Test {
    private static final Logger LOG = LoggerFactory.getLogger(ConformanceC043Test.class);
    private List<Box> boxes;

    public ConformanceC043Test() {}

    private Path getExample() {
        String fileName = "heif_conformance/conformance_files/C043.heic";
