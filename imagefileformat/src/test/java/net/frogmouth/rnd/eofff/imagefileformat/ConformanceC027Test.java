...
public class ConformanceC027Test {
    private static final Logger LOG = LoggerFactory.getLogger(ConformanceC027Test.class);
    private List<Box> boxes;

    public ConformanceC027Test() {}

    private Path getExample() {
        String fileName = "heif_conformance/conformance_files/C027.heic";
