...
public class ConformanceMultilayer003Test {
    private static final Logger LOG = LoggerFactory.getLogger(ConformanceMultilayer003Test.class);
    private List<Box> boxes;

    private Path getExample() {
        String fileName = "heif_conformance/conformance_files/multilayer003.heic";
