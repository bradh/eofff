...
public class ConformanceC026Test {
    private static final Logger LOG = LoggerFactory.getLogger(ConformanceC026Test.class);
    private List<Box> boxes;

    public ConformanceC026Test() {}

    private Path getExample() {
        String fileName = "heif_conformance/conformance_files/C026.heic";
