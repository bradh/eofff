...
public class ConformanceC030Test {
    private static final Logger LOG = LoggerFactory.getLogger(ConformanceC030Test.class);
    private List<Box> boxes;

    public ConformanceC030Test() {}

    private Path getExample() {
        String fileName = "heif_conformance/conformance_files/C030.heic";
