...
public class ConformanceMIAF007Test {
    private static final Logger LOG = LoggerFactory.getLogger(ConformanceMIAF007Test.class);
    private List<Box> boxes;

    private Path getExample() {
        String fileName = "heif_conformance/conformance_files/MIAF007.heic";
