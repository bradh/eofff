...
public class ConformanceC013Test {
    private static final Logger LOG = LoggerFactory.getLogger(ConformanceC013Test.class);
    private List<Box> boxes;

    public ConformanceC013Test() {}

    private Path getExample() {
        String fileName = "heif_conformance/conformance_files/C013.heic";
