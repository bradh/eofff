...
public class ConformanceC008Test {
    private static final Logger LOG = LoggerFactory.getLogger(ConformanceC008Test.class);
    private List<Box> boxes;

    public ConformanceC008Test() {}

    private Path getExample() {
        String fileName = "heif_conformance/conformance_files/C008.heic";
