...
public class ConformanceMIAF003Test {
    private static final Logger LOG = LoggerFactory.getLogger(ConformanceMIAF003Test.class);
    private List<Box> boxes;

    private Path getExample() {
        String fileName = "heif_conformance/conformance_files/MIAF003.heic";
