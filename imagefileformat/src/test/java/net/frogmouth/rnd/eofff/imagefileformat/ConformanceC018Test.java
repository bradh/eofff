...
public class ConformanceC018Test {
    private static final Logger LOG = LoggerFactory.getLogger(ConformanceC018Test.class);
    private List<Box> boxes;

    public ConformanceC018Test() {}

    private Path getExample() {
        String fileName = "heif_conformance/conformance_files/C018.heic";
