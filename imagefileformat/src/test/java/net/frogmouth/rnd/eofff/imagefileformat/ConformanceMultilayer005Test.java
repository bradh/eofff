...
public class ConformanceMultilayer005Test {
    private static final Logger LOG = LoggerFactory.getLogger(ConformanceMultilayer005Test.class);
    private List<Box> boxes;

    private Path getExample() {
        String fileName = "heif_conformance/conformance_files/multilayer005.heic";
