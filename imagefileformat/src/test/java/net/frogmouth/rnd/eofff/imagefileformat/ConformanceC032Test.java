...
public class ConformanceC032Test {
    private static final Logger LOG = LoggerFactory.getLogger(ConformanceC032Test.class);
    private List<Box> boxes;

    public ConformanceC032Test() {}

    private Path getExample() {
        String fileName = "heif_conformance/conformance_files/C032.heic";
