...
public class ConformanceC024Test {
    private static final Logger LOG = LoggerFactory.getLogger(ConformanceC024Test.class);
    private List<Box> boxes;

    public ConformanceC024Test() {}

    private Path getExample() {
        String fileName = "heif_conformance/conformance_files/C024.heic";
