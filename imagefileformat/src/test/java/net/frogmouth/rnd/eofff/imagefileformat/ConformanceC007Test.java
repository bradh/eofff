...
public class ConformanceC007Test {
    private static final Logger LOG = LoggerFactory.getLogger(ConformanceC007Test.class);
    private List<Box> boxes;

    public ConformanceC007Test() {}

    private Path getExample() {
        String fileName = "heif_conformance/conformance_files/C007.heic";
    ...
    public void checkMetaBox() {
        ...
        assertEquals(meta.getNestedBoxes().size(), 8);
