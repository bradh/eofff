...
public class ConformanceC039Test {
    private static final Logger LOG = LoggerFactory.getLogger(ConformanceC039Test.class);
    private List<Box> boxes;

    public ConformanceC039Test() {}

    private Path getExample() {
        String fileName = "heif_conformance/conformance_files/C039.heic";
