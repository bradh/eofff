...
public class ConformanceC006Test {
    private static final Logger LOG = LoggerFactory.getLogger(ConformanceC006Test.class);
    private List<Box> boxes;

    public ConformanceC006Test() {}

    private Path getExample() {
        String fileName = "heif_conformance/conformance_files/C006.heic";
