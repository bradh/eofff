...
public class ConformanceC044Test {
    private static final Logger LOG = LoggerFactory.getLogger(ConformanceC044Test.class);
    private List<Box> boxes;

    public ConformanceC044Test() {}

    private Path getExample() {
        String fileName = "heif_conformance/conformance_files/C044.heic";
    ...
    public void checkFtypBox() {
        ...
        assertEquals(ftyp.getCompatibleBrands().get(0), new FourCC("mif2"));
