...
public class ConformanceC021Test {
    private static final Logger LOG = LoggerFactory.getLogger(ConformanceC021Test.class);
    private List<Box> boxes;

    public ConformanceC021Test() {}

    private Path getExample() {
        String fileName = "heif_conformance/conformance_files/C021.heic";
